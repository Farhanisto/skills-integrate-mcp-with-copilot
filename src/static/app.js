document.addEventListener("DOMContentLoaded", () => {
  ...
  // Store activities for filtering/sorting/search
  let allActivities = {};

  // Function to render activities with filters/sorting/search
  ...
  document.getElementById("sort-select").addEventListener("change", renderActivities);
